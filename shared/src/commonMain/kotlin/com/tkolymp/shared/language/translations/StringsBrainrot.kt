...
val StringsBrainrot = Strings(
    ...
    tutorial = TutorialStrings(
        ...
        boardStickyDesc = "Pinned posts from the big bosses — locked in forever, no cap. Always visible, separate from the daily feed. This is the lore that never expires.",
        ...
        otherAccountDesc = "Your profile card — tap it to flex your info or update your lore. The buttons below are speedrun shortcuts to Payments, Stats, or your personal training arc.",
        otherQrTitle = "ČSTS Drip Code",
        otherQrDesc = "Your personal QR code with your ČSTS dancer ID. Flash it at competitions for instant check-in — no cap, no paperwork, just pure sigma efficiency.",
