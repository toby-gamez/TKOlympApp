...
data class StatsStrings(
    ...
    val rankingLabel: String = "Ranking",
    val totalPointsLabel: String = "Total points",
    val trainingsPerWeekLabel: String = "trainings per week",
    val attendanceLabel: String = "Attendance",
    val attendedLabel: String = "Attended",
    val excusedLabel: String = "Excused",
    val scoreSectionLabel: String = "Score",
    val weeksInARowLabel: String = "weeks in a row",
