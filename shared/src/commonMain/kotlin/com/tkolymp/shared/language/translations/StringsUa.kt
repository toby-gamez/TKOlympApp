...
val StringsUa = Strings(
    ...
    tutorial = TutorialStrings(
        ...
        boardStickyDesc = "Дописи, закріплені координаторами клубу — завжди видимі та відокремлені від звичайних новин.",
        ...
        otherAccountDesc = "Картка профілю — натисніть, щоб переглянути або відредагувати профіль. Кнопки нижче ведуть до Платежів, Статистики або особистої історії тренувань.",
        otherQrTitle = "Код ČSTS для змагань",
        otherQrDesc = "Ваш особистий QR-код з ID танцюриста ČSTS. Показуйте його на змаганнях для швидкої реєстрації — без паперів.",
