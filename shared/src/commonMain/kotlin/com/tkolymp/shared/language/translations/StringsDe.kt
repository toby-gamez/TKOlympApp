...
val StringsDe = Strings(
    ...
    tutorial = TutorialStrings(
        ...
        boardStickyDesc = "Von Koordinatoren angeheftete Beiträge — immer sichtbar und getrennt vom regulären Newsfeed.",
        ...
        otherAccountDesc = "Deine Profilkarte — tippe darauf, um dein Profil anzusehen oder zu bearbeiten. Die Schnellschaltflächen darunter führen dich zu Zahlungen, Statistiken oder deiner Trainingshistorie.",
        otherQrTitle = "ČSTS-Wettkampfcode",
        otherQrDesc = "Dein persönlicher QR-Code mit deiner ČSTS-Tänzer-ID. Zeige ihn bei Wettkämpfen für schnelles Einchecken und Anmelden — kein Papierkram nötig.",
