...
val StringsVi = Strings(
    ...
    tutorial = TutorialStrings(
        ...
        boardStickyDesc = "Bài đăng được ghim bởi ban điều hành câu lạc bộ — luôn hiển thị và tách biệt khỏi bảng tin thông thường.",
        ...
        otherAccountDesc = "Thẻ hồ sơ — nhấn để xem hoặc chỉnh sửa hồ sơ. Các nút bên dưới đưa bạn nhanh đến Thanh toán, Thống kê hoặc lịch sử tập luyện.",
        otherQrTitle = "Mã ČSTS cho thi đấu",
        otherQrDesc = "Mã QR cá nhân chứa ID vũ công ČSTS của bạn. Xuất trình tại các cuộc thi để check-in và đăng ký nhanh — không cần giấy tờ.",
