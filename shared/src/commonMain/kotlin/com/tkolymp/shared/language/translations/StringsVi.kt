...
val StringsVi = Strings(
    ...
    profile = ProfileStrings(
        ...
        facebook = "Facebook",
        website = "Trang web",
        socialUsernameHelper = "Tên người dùng không có @",
        urlHint = "Liên kết đầy đủ, ví dụ https://...",
        facebookNameHint = "Tên hiển thị trên hồ sơ Facebook của bạn",
        note = "Ghi chú",
        noteNotAvailable = "Chưa có ghi chú.",
        formatBold = "Đậm",
        formatItalic = "Nghiêng",
        formatUnderline = "Gạch chân",
        formatBulletList = "Danh sách dấu đầu dòng",
    ),
    ...
    dialogs = DialogStrings(
        ...
        oldPasswordRequired = "Cần nhập mật khẩu cũ",
    ...
    achievements = com.tkolymp.shared.language.AchievementStrings(
        screenTitle = "Thành tích",
        sectionCamps = "Trại huấn luyện",
        sectionMembership = "Thành viên",
        sectionAttendance = "Điểm danh",
        sectionCompetitions = "Cuộc thi",
        sectionRepertoire = "Kho kỹ năng",
        sectionRhythm = "Nhịp điệu",
        sectionDiplomas = "Chứng nhận trại",
        profilePreviewTitle = "Thành tích",
        profilePreviewEmpty = "Chưa có huy hiệu nào",
        lockedLabel = "Đã khóa",
        earnedOnLabel = "Đạt được vào",
        noDiplomasYet = "Chưa có chứng nhận nào",
        diplomaShareButton = "Chia sẻ",
        diplomaCertifies = "Chứng nhận rằng",
        diplomaCampCompleted = "đã hoàn thành trại huấn luyện",
        newBadgeUnlocked = "Huy hiệu mới!",
        newPillLabel = "MỚI",
        viewAchievementsAction = "Xem thành tích",
        campFirstTitle = "Trại đầu tiên",
        campFirstDesc = "Bạn đã hoàn thành trại huấn luyện đầu tiên.",
        camp3Title = "3 trại huấn luyện",
        camp3Desc = "Bạn đã hoàn thành 3 trại huấn luyện.",
        camp5Title = "5 trại huấn luyện",
        camp5Desc = "Bạn đã hoàn thành 5 trại huấn luyện.",
        camp10Title = "10 trại huấn luyện",
        camp10Desc = "Bạn đã hoàn thành 10 trại huấn luyện.",
        camp20Title = "20 trại huấn luyện",
        camp20Desc = "Bạn đã hoàn thành 20 trại huấn luyện.",
        campPerfectTitle = "Điểm danh hoàn hảo",
        campPerfectDesc = "Bạn đã có mặt mọi ngày của một trại huấn luyện.",
        campMultiSeasonTitle = "Lão làng trại huấn luyện",
        campMultiSeasonDesc = "Bạn đã hoàn thành trại huấn luyện trong ít nhất 3 mùa khác nhau.",
        membership1Title = "1 năm trong câu lạc bộ",
        membership1Desc = "Bạn đã là thành viên câu lạc bộ được một năm.",
        membership2Title = "2 năm trong câu lạc bộ",
        membership2Desc = "Bạn đã là thành viên câu lạc bộ được 2 năm.",
        membership3Title = "3 năm trong câu lạc bộ",
        membership3Desc = "Bạn đã là thành viên câu lạc bộ được 3 năm.",
        membership5Title = "5 năm trong câu lạc bộ",
        membership5Desc = "Bạn đã là thành viên câu lạc bộ được 5 năm.",
        membership7Title = "7 năm trong câu lạc bộ",
        membership7Desc = "Bạn đã là thành viên câu lạc bộ được 7 năm.",
        membership10Title = "10 năm trong câu lạc bộ",
        membership10Desc = "Bạn đã là thành viên câu lạc bộ được 10 năm.",
        membership15Title = "15 năm trong câu lạc bộ",
        membership15Desc = "Bạn đã là thành viên câu lạc bộ được 15 năm.",
        streak4Title = "Chuỗi 4 tuần",
        streak4Desc = "Bạn đã tập luyện 4 tuần liên tiếp.",
        streak8Title = "Chuỗi 8 tuần",
        streak8Desc = "Bạn đã tập luyện 8 tuần liên tiếp.",
        streak16Title = "Chuỗi 16 tuần",
        streak16Desc = "Bạn đã tập luyện 16 tuần liên tiếp.",
        lessons50Title = "50 buổi tập",
        lessons50Desc = "Bạn đã tham gia 50 buổi tập.",
        lessons100Title = "100 buổi tập",
        lessons100Desc = "Bạn đã tham gia 100 buổi tập.",
        lessons250Title = "250 buổi tập",
        lessons250Desc = "Bạn đã tham gia 250 buổi tập.",
        competitionFirstTitle = "Cuộc thi đầu tiên",
        competitionFirstDesc = "Bạn đã thi đấu cuộc thi đầu tiên của mình.",
        competition10Title = "10 cuộc thi",
        competition10Desc = "Bạn đã thi đấu 10 cuộc thi.",
        competition25Title = "25 cuộc thi",
        competition25Desc = "Bạn đã thi đấu 25 cuộc thi.",
        competitionFinalFirstTitle = "Vào chung kết",
        competitionFinalFirstDesc = "Bạn đã lần đầu vào chung kết một cuộc thi.",
        competitionPodiumTitle = "Lên bục nhận giải",
        competitionPodiumDesc = "Bạn đã lọt vào top 3 tại một cuộc thi.",
        competitionChampionTitle = "Nhà vô địch",
        competitionChampionDesc = "Bạn đã giành vị trí thứ nhất tại một cuộc thi.",
        competitionVersatileTitle = "Vũ công đa phong cách",
        competitionVersatileDesc = "Bạn đã thi đấu ít nhất 2 bộ môn khác nhau (ví dụ: Standard và Latin).",
        partnership3Title = "Cặp đôi ăn ý",
        partnership3Desc = "Bạn đã thi đấu cùng một bạn nhảy trong 3 mùa giải.",
        partnership5Title = "Cặp đôi hoàn hảo",
        partnership5Desc = "Bạn đã thi đấu cùng một bạn nhảy trong 5 mùa giải.",
        trainers3Title = "3 huấn luyện viên",
        trainers3Desc = "Bạn đã tập luyện với 3 huấn luyện viên khác nhau.",
        trainers5Title = "5 huấn luyện viên",
        trainers5Desc = "Bạn đã tập luyện với 5 huấn luyện viên khác nhau.",
        trainers10Title = "10 huấn luyện viên",
        trainers10Desc = "Bạn đã tập luyện với 10 huấn luyện viên khác nhau.",
        typesExplorerTitle = "Toàn diện",
        typesExplorerDesc = "Bạn đã tham gia ít nhất 3 loại sự kiện khác nhau.",
        earlyBirdTitle = "Chim dậy sớm",
        earlyBirdDesc = "Bạn đã tham gia 10 buổi tập bắt đầu trước 8:00.",
        nightOwlTitle = "Cú đêm",
        nightOwlDesc = "Bạn đã tham gia 10 buổi tập bắt đầu từ 20:00 trở đi.",
        weekendWarriorTitle = "Chiến binh cuối tuần",
