...
val StringsSl = Strings(
    ...
    tutorial = TutorialStrings(
        ...
        boardStickyDesc = "Objave, ki jih pripnejo koordinatorji kluba — vedno vidne in ločene od rednih novic.",
        ...
        otherAccountDesc = "Kartica profila — dotakni se za ogled ali urejanje profila. Gumbi spodaj omogočajo hiter skok na Plačila, Statistike ali osebno zgodovino treningov.",
        otherQrTitle = "Koda ČSTS za tekmovanja",
        otherQrDesc = "Tvoja osebna QR koda z ID-jem plesalca ČSTS. Pokaži jo na tekmovanjih za hitro prijavo in registracijo — brez papirjev.",
