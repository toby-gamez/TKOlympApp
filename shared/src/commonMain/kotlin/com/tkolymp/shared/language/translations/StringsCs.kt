...
val StringsCs = Strings(
    ...
    tutorial = TutorialStrings(
        ...
        boardStickyDesc = "Příspěvky připnuté koordinátory klubu — vždy viditelné a oddělené od běžných novinek.",
        ...
        otherAccountDesc = "Karta profilu — klepni pro zobrazení nebo úpravu profilu. Tlačítka níže umožňují rychlý přechod na Platby, Statistiky nebo přehled tréninků.",
        otherQrTitle = "Kód ČSTS pro soutěže",
        otherQrDesc = "Tvůj osobní QR kód s tanečním ID od ČSTS. Ukaž ho na soutěžích pro rychlé odbavení a registraci — bez papírování.",
