...
val StringsEn = Strings(
    ...
    tutorial = TutorialStrings(
        ...
        boardStickyDesc = "Pinned posts from club coordinators — always visible and separate from the regular news feed.",
        ...
        otherAccountDesc = "Your profile card — tap it to view or edit your profile. Quick buttons below let you jump to Payments, Stats, or your personal training history.",
        otherQrTitle = "ČSTS Competition Code",
        otherQrDesc = "Your personal QR code containing your ČSTS dancer ID. Show it at competitions for quick check-in and registration — no paperwork needed.",
